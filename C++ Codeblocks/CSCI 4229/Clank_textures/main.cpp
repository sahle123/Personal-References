 ...
 *  Sahle A. Alturaigi
 *  Oct. 23rd, 2013
 *  Finished: Oct. 25th, 2013
 *
 *  CSCI 4229 Hw: Textures
 *  Spent 8 hours so far
 *
 *  This hw will demonstrate how to implement textures onto OpenGL (glut?)
 *  objects. I will be using my Clank object as the object I will apply
 *  textures to. Most of the texture code will be in the "clank_builder.h"
 *  header file.
 *
 *  Got some help from the following website:
 *  And from Professor Schreüder, Willam's example code
 *  Using a modified version of CSCIx229.h from Professor
 *  Schreüder's class
 *
 *
 * Self-Notes:
